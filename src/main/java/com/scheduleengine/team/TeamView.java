...
public class TeamView {
  ...
  public VBox getView() {
    ...
    TableColumn<Team, String> contactEmailCol = new TableColumn<>("Contact Email");
    contactEmailCol.setCellValueFactory(new PropertyValueFactory<>("contactEmail"));
    contactEmailCol.setPrefWidth(200);

    TableColumn<Team, String> contactPhoneCol = new TableColumn<>("Contact Phone");
    ...
    com.scheduleengine.common.TablePreferencesUtil.attachToggleMenu(table, "team");
