...
public class LeagueView {
  ...
  private final ObservableList<League> data;
  ...
  public VBox getView() {
    ...
    TableColumn<League, Number> idCol = new TableColumn<>("ID");
    idCol.setCellValueFactory(new PropertyValueFactory<>("id"));
    idCol.setComparator(java.util.Comparator.comparingLong(Number::longValue));
