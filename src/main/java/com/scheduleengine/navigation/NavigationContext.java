...
public class NavigationContext {
    ...
    public NavigationContext navigateToLevel(int level) {
        ...
        for (NavigationNode node : newBreadcrumb) {
            if (node.getContextObject() != null) {
                newContextData.put(node.getViewId(), node.getContextObject());
            }
        }
    ...
    public String getCurrentViewId() {
        ...
        return breadcrumb.get(breadcrumb.size() - 1).getViewId();
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < breadcrumb.size(); i++) {
            ...
            sb.append(breadcrumb.get(i).getDisplayName());
        }
        return sb.toString();
    }
}
